...
export default function NewsBanner({
  ...
  return (
    <div className='relative py-8 overflow-hidden isolate'>
      ...
      <div className='absolute inset-0 bg-gradient-to-r from-amber-600 to-purple-950 dark:from-gray-900 dark:via-purple-950 dark:to-amber-950 z-0' />
      ...
      <div className='relative z-10 max-w-7xl mx-auto px-4 text-center'>
        <motion.h1
          className={`${fascinate.className} text-4xl md:text-5xl font-bold mb-4 text-white drop-shadow-[0_0_12px_rgba(192,132,252,0.8)]`}
        ...
        <motion.div
          className='w-24 h-1 mx-auto bg-gradient-to-r from-amber-400 to-purple-400 mb-6 rounded-full'
          initial={{ width: 0 }}
          animate={{ width: "6rem" }}
        ...
        <motion.p
          className='text-lg max-w-3xl mx-auto text-amber-100 leading-6 drop-shadow-[0_0_6px_rgba(192,132,252,0.4)]'
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
